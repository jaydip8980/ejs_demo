...
jQuery(window).on("load", function() {
    ...
    addSwitcher(), jQuery(".switch-btn").on("click", function() {
        ...
        jQuery("body").addClass("frame"), jQuery("body").removeClass("boxed wide-layout"), jQuery("#ThemeRangeSlider").show("slow"), jQuery(".main-bar-wraper").addClass("sticky-no"), jQuery(".main-bar-wraper").removeClass("sticky-header")
        ...
        var e = jQuery("<div>").append($(".header-nav .logo-header").clone()).html(),
            a = jQuery("<div>").append($(".header-nav .navbar-nav").clone()).html(),
            i = jQuery("<div>").append($(".header-nav .footer-menu").clone()).html();
        jQuery(".content-scroll").removeClass("content-scroll mCustomScrollbar _mCS_1 mCS_no_scrollbar"), jQuery(".header-nav").empty(), jQuery(".header-nav").append(e).append(a).append(i)
    }), window.location.href.indexOf("index-2.html") > -1 && jQuery(".menubar-box").remove()
});
...
function themeFramePadding() {
    ...
    "" == e && (e = 20), $("#slider-range-3").length > 0 && $("#slider-range-3").unbind().slider({
        ...
        orientation: "horizontal",
        slide: function(e, a) {
            frameSlider = a.value, $("#" + this.id).prev().val(frameSlider + "px"), $("#bg").css("padding", frameSlider + "px"), setCookie("frame_value", frameSlider, 1)
        }
    })
}
...
function setThemePanel() {
    jQuery.each(themeOption, function(e, a) {
        themeOptionItemValue = getCookie(a + "_value"), "" != themeOptionItemValue && ("themeStandardColor" == a ? jQuery(".skin").attr("href", themeOptionItemValue) : "themeFullColor" == a ? jQuery(".skin").attr("href", themeOptionItemValue) : "layout" == a ? (jQuery("." + a + "-view li").removeClass("active"), setTimeout(function() {
            jQuery("." + a + "-view  ." + themeOptionItemValue).addClass("active")
        }, 300), "frame" == themeOptionItemValue ? (jQuery("#ThemeRangeSlider").show("slow"), jQuery("body").addClass(themeOptionItemValue), themeOptionFrameValue = getCookie("frame_value"), "" == themeOptionFrameValue && (themeOptionFrameValue = 20), jQuery("#FramePadding").val(themeOptionFrameValue + "px"), jQuery("#bg").css("padding", themeOptionFrameValue + "px")) : jQuery("body").addClass(themeOptionItemValue)) : "header" == a ? (jQuery("." + a + "-view li").removeClass("active"), "sticky-header" == themeOptionItemValue ? jQuery("." + a + "-view").find(".header-fixed").addClass("active") : "sticky-no" == themeOptionItemValue && jQuery("." + a + "-view").find(".header-static").addClass("active"), jQuery(".main-bar-wraper").addClass(themeOptionItemValue)) : "menubar" == a ? (jQuery("." + a + "-view li").removeClass("active"), "left" == themeOptionItemValue ? (jQuery("." + a + "-view").find(".menubar-left").addClass("active"), jQuery(".page-wraper").addClass("sidemenu"), jQuery(".header-nav").addClass("sidenav content-scroll")) : "top" == themeOptionItemValue && (jQuery("." + a + "-view").find(".menubar-top").addClass("active"), jQuery(".page-wraper").removeClass("sidemenu"), jQuery(".header-nav").removeClass("sidenav"))) : "bgColor" == a && "" != themeOptionItemValue && 1 != themeOptionItemValue ? (jQuery("#bg").css("background-color", themeOptionItemValue), jQuery("#bg").css("background-image", "")) : "bgImage" == a && "" != themeOptionItemValue && 1 != themeOptionItemValue ? jQuery("#bg").css({
            backgroundImage: "url(" + themeOptionItemValue + ")"
        }) : "bgPatten" == a && "" != themeOptionItemValue && 1 != themeOptionItemValue && (jQuery("#bg").css({
            backgroundImage: "url(" + themeOptionItemValue + ")"
        }), jQuery("#bg").css("background-size", "auto")))
    });
    var e = getCookie("themeStandardColor_logo_selector"),
        a = getCookie("themeFullColor_logo_selector");
    if ("" != e)
        for (var i = getCookie("themeStandardColor_logo_image"), t = e.split(","), l = i.split(","), o = t.length, s = 0; s < o; s++) jQuery(t[s]).attr("src", l[s]);
    if ("" != a) {
        var r = getCookie("themeFullColor_logo_image");
        for (t = a.split(","), l = r.split(","), o = t.length, s = 0; s < o; s++) jQuery(t[s]).attr("src", l[s])
    }
}

function setThemeLogo(e) {
    var a = getCookie(e + "_logo");
    "" != a && (jQuery(".logo-white img").attr("src", a), jQuery(".logo-dark img").attr("src", a), jQuery(".logo-center .logo-c").attr("src", a))
}

function setCookie(e, a, i) {
    var t = new Date;
    t.setTime(t.getTime() + 18e5);
    var l = "expires=" + t.toString();
...
themeOption.layout = ["wide", "boxed", "frame", "frame_value", "layout_value"], themeOption.themeStandardColor = ["skin-1", "skin-2", "skin-3", "skin-4", "skin-5", "skin-6", "skin-7", "skin-8", "skin-9", "skin-10", "themeStandardColor_value", "themeStandardColor_logo"], themeOption.themeFullColor = ["css/skin/skin-1", "css/skin/skin-2", "css/skin/skin-3", "css/skin/skin-4", "css/skin/skin-5", "css/skin/skin-6", "css/skin/skin-7", "css/skin/skin-8", "css/skin/skin-9", "css/skin/skin-10", "themeFullColor_value", "themeFullColor_logo"], themeOption.header = ["fixed", "static", "header_value"], themeOption.menubar = ["left", "top", "menubar_value"], themeOption.bgColor = ["#ff5e14", "#d2151e", "#fdb400", "#0086f0", "#6a1a1f", "#019444", "#00c6ff", "#e87800", "#cc9f5a", "#bd5ec6", "bgColor_value"], themeOption.bgImage = ["bg1.jpg", "error-404.html", "error-404.html", "error-404.html", "bgImage_value"], themeOption.bgPatten = ["pt1.jpg", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "error-404.html", "bgPatten_value"], jQuery(window).on("load", function() {
    jQuery(document).on("click", ".theme-color", function() {
        ...
        for (var e = jQuery(this).data("logo-selector").split(","), a = jQuery(this).data("logo-image").split(","), i = e.length, t = 0; t < i; t++) jQuery(e[t]).attr("src", a[t]);
        return !1
    }), jQuery(document).on("click", ".theme-panel-save li a, .theme-panel-save li img", function() {
        var e = jQuery(this).parent().parent().attr("val");
        if ("themeStandardColor" == e || "themeFullColor" == e) var a = jQuery(this).data("color-theme");
        else a = jQuery(this).attr("dir");
        if ("bgColor" == e) deleteCookie("bgImage_value"), deleteCookie("bgPatten_value");
        else if ("bgImage" == e) deleteCookie("bgColor_value"), deleteCookie("bgPatten_value");
        else if ("bgPatten" == e) deleteCookie("bgColor_value"), deleteCookie("bgImage_value");
        else if ("themeStandardColor" == e || "themeFullColor" == e) {
            var i = jQuery(this).data("logo-selector"),
                t = jQuery(this).data("logo-image");
            setCookie(e + "_logo_selector", i, 1), setCookie(e + "_logo_image", t, 1), "themeStandardColor" == e ? deleteCookie("themeFullColor_value") : "themeFullColor" == e && deleteCookie("themeStandardColor_value")
        }
        setCookie(e + "_value", a, 1)
    }), setThemePanel()
});